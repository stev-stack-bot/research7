...
def run_asymmetric_grid_search(symbol):
    ...
    print(f"\n[LONG] Optimizing parameter space for {symbol} longs (min trades >= 5 in train)...")
    ...
    print(f"[SHORT] Optimizing parameter space for {symbol} shorts (min trades >= 5 in train)...")
    ...
    if best_long_params and best_short_params:
        ...
        print(f"\n=======================================================")
        print(f" ASYMMETRIC VALIDATION RESULTS ({symbol})")
        print(f"=======================================================")
...
def main():
    for sym in ["ETH", "BTC", "SOL"]:
        print(f"\n=======================================================")
        print(f" RUNNING ASYMMETRIC OPTIMIZATION: {sym}")
        print(f"=======================================================")
        run_asymmetric_grid_search(sym)
